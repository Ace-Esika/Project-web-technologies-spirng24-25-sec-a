<?php
    ...
    if (!$con) {
        ...
        $sql = "INSERT INTO user_info (id,first_name, last_name, email, password, dob, img_url, address) VALUES ('$id_','$first_name', '$last_name', '$email', '$password', '$dob', '$file_path', '$address')";

        if (mysqli_query($con, $sql)) {
            echo "<script>alert('Registration successful!');</script>";
            move_uploaded_file($_FILES['img_url']['tmp_name'], "../img/" . $file_path);
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form id="form" class="input_container" method="POST">
        <div class="row">
        ...
        <div class="form_group">
          <label>ID</label>
          <input type="text" id="id_" name="id_" placeholder="ID" />
        ...
        <div class="form_group">
          ...
          <input type="file" id="file_path" accept="image/*" name="img_url"/>
        ...
        <div style="margin-top: 20px">
          <input style="width : 100px" onclick="ok()" type="submit" value="Submit"></input>
